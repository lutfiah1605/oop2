...
<body>
    ...
    <form action="" name="edit" method="post">
        <div class="card col-6 mt-2 ms-2">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label class="form-label">Harga/Ltr</label>
                    <input type="text" name="harga_ltr" id="harga_ltr" class="form-control" onchange="total()" value="<?php echo $row['harga_ltr']; ?>">
                </div>
                <div class="mb-3">
                    <label class="form-label">Harga/Jiwa</label>
                    <input type="text" name="harga_jiwa" id="harga_jiwa" class="form-control" value="<?php echo $row['harga_jiwa']; ?>" readonly>
                </div>
                <div class="mb-3">
